...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#2B2F36] flex items-center justify-center p-6 selection:bg-[#007BFF]/30 overflow-hidden relative">
      {/* Subtle Background Glow for Brand Depth */}
      ...
      {/* Main Container - Card-based on desktop, full-screen on mobile */}
      <div className="w-full max-w-[480px] h-full md:h-auto flex flex-col justify-between md:justify-center items-center gap-12 animate-in fade-in duration-1000">
        ...
        {/* Session Expired Banner (Edge Case) */}
        {sessionExpired && (
        ...
        {/* LOGO SECTION - Top Third on Mobile */}
        ...
        {/* TAGLINE SECTION - Middle on Mobile */}
        ...
        {/* CTA SECTION - Bottom Third on Mobile */}
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 opacity-10 pointer-events-none">
        <span className="text-[10px] font-black text-white uppercase tracking-[0.8em]">Neural Network v1.0</span>
      </div>
    </div>
  );
};
